...
- Fixed missed case where `minor_planet_check()` would crash when encountering nearly-parabolic orbits far from the Sun. The raises PyEphem `RuntimeError` exceptions are caught and converted to warnings.
